...
def launch():
    ...
    with gr.Blocks() as demo:
        ...
        generate_button.click(
            fn=lambda lang, txt, idx: generate(
                lang, txt, audio_path, IMAGE_CHOICES[idx], video_path
            ),
            inputs=[language, text, image_index],
            outputs=video_output,
        )

    demo.launch(share=True, allowed_paths=[str(avatar_dir)])
